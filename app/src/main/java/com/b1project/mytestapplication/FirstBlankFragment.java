 ...
 * {@link FirstBlankFragment.OnFragmentInteractionListener} interface
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri uri = Uri.parse("content://com.b1project.mytestapplication/firstblankfragment");
                onButtonPressed(uri.buildUpon()
                        .appendQueryParameter("username", String.valueOf(mEditText.getText()))
                        .build());
            }
        });
        return view;
